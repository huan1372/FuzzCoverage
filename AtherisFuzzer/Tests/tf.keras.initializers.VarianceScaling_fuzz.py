#This is a Python API fuzzer for tf.keras.initializers.VarianceScaling
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.initializers.VarianceScaling_exception.txt","a")
	try:
		scale_choices = []
		...
		arg_class = tf.keras.initializers.VarianceScaling(scale=scale,mode=mode,distribution=distribution)
