#This is a Python API fuzzer for tf.keras.layers.GlobalAvgPool1D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.GlobalAvgPool1D_exception.txt","a")
	try:
		name_choices = []
		...
		arg_class = tf.keras.layers.GlobalAvgPool1D(name=name,trainable=trainable,batch_input_shape=batch_input_shape,dtype=dtype,data_format=data_format)
