#This is a Python API fuzzer for tf.signal.vorbis_window
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.signal.vorbis_window_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.signal.vorbis_window(parameter_0,dtype=dtype)
