#This is a Python API fuzzer for tf.math.less
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.less_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.less(parameter_0,parameter_1)
