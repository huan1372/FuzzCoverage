#This is a Python API fuzzer for tf.strings.format
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.strings.format_exception.txt","a")
	try:
		parameter_0_choices = []
		parameter_0_STR_strlist = ['a: {}, b: {}, suffix', 'tensor: {}, suffix'] 
		...
		arg_class = tf.strings.format(parameter_0,parameter_1)
