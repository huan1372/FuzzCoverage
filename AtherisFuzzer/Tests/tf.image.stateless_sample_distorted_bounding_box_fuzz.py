...
def TestOneInput(data):
	...
	try:
		...
		bounding_boxes = bounding_boxes_choices[fh.get_int()%1]
		seed_choices = []
		seed = seed_choices[fh.get_int()%0]
		_ = tf.image.stateless_sample_distorted_bounding_box(parameter_0,bounding_boxes=bounding_boxes,seed=seed)
