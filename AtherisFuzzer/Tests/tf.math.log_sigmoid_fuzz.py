#This is a Python API fuzzer for tf.math.log_sigmoid
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.log_sigmoid_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.log_sigmoid(parameter_0)
