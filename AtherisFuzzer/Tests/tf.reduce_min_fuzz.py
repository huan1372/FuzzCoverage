#This is a Python API fuzzer for tf.reduce_min
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.reduce_min_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.reduce_min(parameter_0)
