#This is a Python API fuzzer for tf.keras.utils.pack_x_y_sample_weight
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.utils.pack_x_y_sample_weight_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.utils.pack_x_y_sample_weight(parameter_0,parameter_1)
