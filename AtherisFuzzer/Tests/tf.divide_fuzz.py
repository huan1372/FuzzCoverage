#This is a Python API fuzzer for tf.divide
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.divide_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.divide(parameter_0,parameter_1)
