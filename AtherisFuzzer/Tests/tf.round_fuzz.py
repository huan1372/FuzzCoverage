#This is a Python API fuzzer for tf.round
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.round_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.round(parameter_0)
