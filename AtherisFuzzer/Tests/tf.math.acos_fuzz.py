#This is a Python API fuzzer for tf.math.acos
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.acos_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.acos(parameter_0,)
