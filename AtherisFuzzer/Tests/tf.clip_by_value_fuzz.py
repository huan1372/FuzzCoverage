...
def TestOneInput(data):
	...
	try:
		...
		clip_value_min = clip_value_min_choices[fh.get_int()%1]
		clip_value_max_choices = []
		clip_value_max_INT = fh.get_int()
		clip_value_max_choices.append(clip_value_max_INT)
		clip_value_max = clip_value_max_choices[fh.get_int()%1]
		parameter_1_choices = []
		...
		_ = tf.clip_by_value(parameter_0,clip_value_min=clip_value_min,clip_value_max=clip_value_max,parameter_1,parameter_2)
