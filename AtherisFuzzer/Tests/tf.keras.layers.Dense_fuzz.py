...
def TestOneInput(data):
	...
	try:
		...
		kernel_initializer_STR_strlist = ['', 'VarianceScaling', 'zeros', 'ones', 'same', '1', 'glorot_normal', 'valid', 'sum', 'GlorotUniform'] 
		...
		kernel_initializer_TF_OBJECT_tfobjlist = ['', 'zeros', 'same', '1', 'valid', 'sum', 'TruncatedNormal'] 
		...
		kernel_regularizer_STR_strlist = ['', 'zeros', 'same', '1', 'l1', 'valid', 'sum'] 
		...
		activation_choices = []
		activation_STR_strlist = ['', 'zeros', 'sigmoid', 'same', '1', 'relu', 'valid', 'sum', 'linear', 'softmax', 'softplus', 'tanh'] 
		...
		activity_regularizer_STR_strlist = ['', 'zeros', 'same', '1', 'l2', 'valid', 'sum'] 
		...
		name_choices = []
		name_STR_strlist = ['', 'zeros', 'predictions', 'same', '1', 'out', 'valid', 'sum', 'dense_2', 'dense', 'dense_1', 'dense_3'] 
