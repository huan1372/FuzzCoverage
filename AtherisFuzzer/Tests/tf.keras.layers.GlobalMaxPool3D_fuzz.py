#This is a Python API fuzzer for tf.keras.layers.GlobalMaxPool3D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.GlobalMaxPool3D_exception.txt","a")
	try:
		name_choices = []
		...
		arg_class = tf.keras.layers.GlobalMaxPool3D(name=name,trainable=trainable,dtype=dtype,data_format=data_format,batch_input_shape=batch_input_shape)
