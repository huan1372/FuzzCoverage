#This is a Python API fuzzer for tf.image.rgb_to_hsv
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.image.rgb_to_hsv_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.image.rgb_to_hsv(parameter_0)
