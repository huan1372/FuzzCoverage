#This is a Python API fuzzer for tf.keras.layers.GlobalMaxPooling1D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.GlobalMaxPooling1D_exception.txt","a")
	try:
		name_choices = []
		name_STR_strlist = ['global_max_pooling1d', 'global_max_pooling1d_1'] 
		...
		arg_class = tf.keras.layers.GlobalMaxPooling1D(name=name,trainable=trainable,batch_input_shape=batch_input_shape,dtype=dtype,data_format=data_format)
