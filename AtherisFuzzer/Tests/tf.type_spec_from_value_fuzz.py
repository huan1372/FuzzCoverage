#This is a Python API fuzzer for tf.type_spec_from_value
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.type_spec_from_value_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.type_spec_from_value(parameter_0)
