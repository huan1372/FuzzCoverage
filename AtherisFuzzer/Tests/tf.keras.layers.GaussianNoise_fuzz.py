#This is a Python API fuzzer for tf.keras.layers.GaussianNoise
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.GaussianNoise_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		name_choices = []
		name_STR_strlist = ['gaussian_noise'] 
		...
		arg_class = tf.keras.layers.GaussianNoise(parameter_0,dtype=dtype,stddev=stddev,name=name,trainable=trainable,batch_input_shape=batch_input_shape)
