#This is a Python API fuzzer for tf.keras.backend.is_keras_tensor
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.backend.is_keras_tensor_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.backend.is_keras_tensor(parameter_0)
