#This is a Python API fuzzer for tf.math.sigmoid
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.sigmoid_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		name_choices = []
		name_STR_strlist = ['logistic', 'probabilities'] 
		name_STR = name_STR_strlist[fh.get_int(min_int=0, max_int=len(name_STR_strlist)-1)]
		name_choices.append(name_STR)
		name = name_choices[0]
		arg_class = tf.math.sigmoid(parameter_0,name=name)
