#This is a Python API fuzzer for tf.math.count_nonzero
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.count_nonzero_exception.txt","a")
	try:
		parameter_0_choices = []
		# Tensor generation for parameter_0
		parameter_0_DTYPES = [tf.bool,tf.int32]
		...
		axis = axis_choices[0]
		arg_class = tf.math.count_nonzero(parameter_0,axis=axis)
