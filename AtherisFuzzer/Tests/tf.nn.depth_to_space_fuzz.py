#This is a Python API fuzzer for tf.nn.depth_to_space
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.nn.depth_to_space_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.nn.depth_to_space(parameter_0,parameter_1)
