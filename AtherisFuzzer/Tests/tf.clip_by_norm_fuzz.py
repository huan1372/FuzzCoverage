#This is a Python API fuzzer for tf.clip_by_norm
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.clip_by_norm_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.clip_by_norm(parameter_0,parameter_1)
