#This is a Python API fuzzer for tf.math.tanh
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.tanh_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.tanh(parameter_0)
