#This is a Python API fuzzer for tf.keras.layers.Conv3DTranspose
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.Conv3DTranspose_exception.txt","a")
	try:
		name_choices = []
		...
		output_padding_LIST = fh.get_int_list(min_length=3, max_length=3)
