#This is a Python API fuzzer for tf.bitcast
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.bitcast_exception.txt","a")
	try:
		parameter_0_choices = []
		# Tensor generation for parameter_0
		parameter_0_DTYPES = [tf.uint32,tf.float32]
		...
		parameter_1_choices = []
		parameter_1_DTYPE_dtypelist = ['tf.uint8'] 
		...
		arg_class = tf.bitcast(parameter_0,parameter_1)
