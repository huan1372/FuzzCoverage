#This is a Python API fuzzer for tf.image.random_jpeg_quality
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.image.random_jpeg_quality_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.image.random_jpeg_quality(parameter_0,parameter_1,parameter_2)
