#This is a Python API fuzzer for tf.shape
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.shape_exception.txt","a")
	try:
		parameter_0_choices = []
		parameter_0_INT = fh.get_int()
		parameter_0_choices.append(parameter_0_INT)
		parameter_0_LIST = fh.get_int_list(min_length=2, max_length=9)
		parameter_0_choices.append(parameter_0_LIST)
		# Tensor generation for parameter_0
		parameter_0_DTYPES = [tf.float32,tf.int32,tf.bool,tf.int64]
		...
		arg_class = tf.shape(parameter_0)
