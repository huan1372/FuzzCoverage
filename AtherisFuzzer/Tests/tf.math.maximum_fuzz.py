#This is a Python API fuzzer for tf.math.maximum
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.maximum_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.maximum(parameter_0,parameter_1)
