#This is a Python API fuzzer for tf.io.serialize_tensor
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.io.serialize_tensor_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.io.serialize_tensor(parameter_0)
