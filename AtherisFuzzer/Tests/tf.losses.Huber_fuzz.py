#This is a Python API fuzzer for tf.losses.Huber
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.losses.Huber_exception.txt","a")
	try:
		reduction_choices = []
		...
		arg_class = tf.losses.Huber(reduction=reduction)
