#This is a Python API fuzzer for tf.keras.activations.hard_sigmoid
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.activations.hard_sigmoid_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.activations.hard_sigmoid(parameter_0)
