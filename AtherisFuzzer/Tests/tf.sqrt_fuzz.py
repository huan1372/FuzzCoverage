#This is a Python API fuzzer for tf.sqrt
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.sqrt_exception.txt","a")
	try:
		parameter_0_choices = []
		parameter_0_FLOAT = fh.get_float()
		parameter_0_choices.append(parameter_0_FLOAT)
		# Tensor generation for parameter_0
		parameter_0_DTYPES = [tf.float32,tf.complex128]
