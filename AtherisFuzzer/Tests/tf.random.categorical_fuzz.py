#This is a Python API fuzzer for tf.random.categorical
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.random.categorical_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		num_samples_choices = []
		num_samples_INT = fh.get_int()
		num_samples_choices.append(num_samples_INT)
		num_samples = num_samples_choices[0]
		arg_class = tf.random.categorical(parameter_0,dtype=dtype,num_samples=num_samples)
