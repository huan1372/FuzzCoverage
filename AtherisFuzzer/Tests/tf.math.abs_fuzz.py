#This is a Python API fuzzer for tf.math.abs
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.abs_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.abs(parameter_0)
