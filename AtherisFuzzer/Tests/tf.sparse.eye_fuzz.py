#This is a Python API fuzzer for tf.sparse.eye
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.sparse.eye_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.sparse.eye(parameter_0)
