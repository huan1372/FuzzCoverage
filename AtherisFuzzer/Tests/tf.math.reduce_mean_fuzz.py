#This is a Python API fuzzer for tf.math.reduce_mean
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.reduce_mean_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.reduce_mean(parameter_0,axis=axis,keepdims=keepdims)
