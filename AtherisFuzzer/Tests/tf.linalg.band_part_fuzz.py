#This is a Python API fuzzer for tf.linalg.band_part
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.linalg.band_part_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.linalg.band_part(parameter_0,parameter_1,parameter_2)
