#This is a Python API fuzzer for tf.keras.initializers.variance_scaling
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.initializers.variance_scaling_exception.txt","a")
	try:
		scale_choices = []
		...
		arg_class = tf.keras.initializers.variance_scaling(scale=scale,mode=mode,distribution=distribution)
