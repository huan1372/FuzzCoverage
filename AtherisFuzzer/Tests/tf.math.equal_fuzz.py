#This is a Python API fuzzer for tf.math.equal
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.equal_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.equal(parameter_0,parameter_1)
