#This is a Python API fuzzer for tf.keras.layers.GlobalMaxPooling3D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.GlobalMaxPooling3D_exception.txt","a")
	try:
		name_choices = []
		name_STR_strlist = ['global_max_pooling3d', 'global_max_pooling3d_1'] 
		...
		arg_class = tf.keras.layers.GlobalMaxPooling3D(name=name,trainable=trainable,dtype=dtype,data_format=data_format,batch_input_shape=batch_input_shape)
