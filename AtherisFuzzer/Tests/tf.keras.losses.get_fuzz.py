#This is a Python API fuzzer for tf.keras.losses.get
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.losses.get_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.losses.get(parameter_0)
