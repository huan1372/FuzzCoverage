#This is a Python API fuzzer for tf.keras.layers.AveragePooling3D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.AveragePooling3D_exception.txt","a")
	try:
		strides_choices = []
		...
		arg_class = tf.keras.layers.AveragePooling3D(strides=strides,padding=padding,pool_size=pool_size,name=name,trainable=trainable,batch_input_shape=batch_input_shape,dtype=dtype,data_format=data_format)
