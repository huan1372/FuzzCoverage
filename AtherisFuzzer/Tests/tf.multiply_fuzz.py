#This is a Python API fuzzer for tf.multiply
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.multiply_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.multiply(parameter_0,parameter_1)
