#This is a Python API fuzzer for tf.subtract
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.subtract_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.subtract(parameter_0,parameter_1)
