#This is a Python API fuzzer for tf.nn.relu
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.nn.relu_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.nn.relu(parameter_0)
