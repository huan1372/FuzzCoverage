#This is a Python API fuzzer for tf.math.rsqrt
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.rsqrt_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.rsqrt(parameter_0)
