#This is a Python API fuzzer for tf.keras.layers.Conv2DTranspose
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.Conv2DTranspose_exception.txt","a")
	try:
		name_choices = []
