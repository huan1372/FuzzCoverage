#This is a Python API fuzzer for tf.metrics.MeanRelativeError
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.metrics.MeanRelativeError_exception.txt","a")
	try:
		normalizer_choices = []
		...
		arg_class = tf.metrics.MeanRelativeError(normalizer=normalizer)
