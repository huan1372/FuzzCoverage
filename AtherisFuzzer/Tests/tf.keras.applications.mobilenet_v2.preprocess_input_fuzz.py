#This is a Python API fuzzer for tf.keras.applications.mobilenet_v2.preprocess_input
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.applications.mobilenet_v2.preprocess_input_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.applications.mobilenet_v2.preprocess_input(parameter_0)
