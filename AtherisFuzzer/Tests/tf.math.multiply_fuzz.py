#This is a Python API fuzzer for tf.math.multiply
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.multiply_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.multiply(parameter_0,parameter_1)
