#This is a Python API fuzzer for tf.math.log1p
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.log1p_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.log1p(parameter_0)
