#This is a Python API fuzzer for tf.keras.losses.CategoricalCrossentropy
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.losses.CategoricalCrossentropy_exception.txt","a")
	try:
		reduction_choices = []
		...
		arg_class = tf.keras.losses.CategoricalCrossentropy(reduction=reduction,from_logits=from_logits)
