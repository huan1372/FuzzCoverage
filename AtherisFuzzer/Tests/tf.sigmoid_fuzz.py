#This is a Python API fuzzer for tf.sigmoid
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.sigmoid_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.sigmoid(parameter_0)
