#This is a Python API fuzzer for tf.image.central_crop
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.image.central_crop_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.image.central_crop(parameter_0,parameter_1)
