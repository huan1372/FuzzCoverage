#This is a Python API fuzzer for tf.nn.log_softmax
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.nn.log_softmax_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		axis = axis_choices[0]
		arg_class = tf.nn.log_softmax(parameter_0,axis=axis)
