#This is a Python API fuzzer for tf.math.log
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.log_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.log(parameter_0)
