#This is a Python API fuzzer for tf.cos
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.cos_exception.txt","a")
	try:
		parameter_0_choices = []
