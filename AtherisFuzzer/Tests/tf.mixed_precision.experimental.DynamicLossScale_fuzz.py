#This is a Python API fuzzer for tf.mixed_precision.experimental.DynamicLossScale
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.mixed_precision.experimental.DynamicLossScale_exception.txt","a")
	try:
		...
		arg_class = tf.mixed_precision.experimental.DynamicLossScale(initial_loss_scale=initial_loss_scale,increment_period=increment_period,multiplier=multiplier,parameter_0)
