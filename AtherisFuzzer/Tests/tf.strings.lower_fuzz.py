#This is a Python API fuzzer for tf.strings.lower
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.strings.lower_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.strings.lower(parameter_0)
