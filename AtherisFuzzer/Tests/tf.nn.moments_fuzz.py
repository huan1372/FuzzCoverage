#This is a Python API fuzzer for tf.nn.moments
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.nn.moments_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.nn.moments(parameter_0,axes=axes,keepdims=keepdims,parameter_1)
