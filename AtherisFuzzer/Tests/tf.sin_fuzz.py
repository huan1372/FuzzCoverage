#This is a Python API fuzzer for tf.sin
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.sin_exception.txt","a")
	try:
		parameter_0_choices = []
