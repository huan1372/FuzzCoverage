#This is a Python API fuzzer for tf.nn.conv2d
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.nn.conv2d_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.nn.conv2d(parameter_0,parameter_1,strides=strides,padding=padding)
