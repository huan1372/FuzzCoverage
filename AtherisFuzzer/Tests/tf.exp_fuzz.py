#This is a Python API fuzzer for tf.exp
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.exp_exception.txt","a")
	try:
		parameter_0_choices = []
