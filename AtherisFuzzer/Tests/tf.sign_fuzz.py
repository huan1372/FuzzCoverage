#This is a Python API fuzzer for tf.sign
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.sign_exception.txt","a")
	try:
		parameter_0_choices = []
