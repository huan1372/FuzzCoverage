#This is a Python API fuzzer for tf.keras.layers.MaxPool2D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.MaxPool2D_exception.txt","a")
	try:
		pool_size_choices = []
		...
		arg_class = tf.keras.layers.MaxPool2D(pool_size=pool_size,input_shape=input_shape,strides=strides,padding=padding,parameter_0,name=name,trainable=trainable,dtype=dtype,data_format=data_format,batch_input_shape=batch_input_shape)
