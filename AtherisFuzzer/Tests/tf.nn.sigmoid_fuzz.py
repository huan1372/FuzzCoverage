#This is a Python API fuzzer for tf.nn.sigmoid
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.nn.sigmoid_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.nn.sigmoid(parameter_0)
