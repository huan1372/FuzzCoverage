#This is a Python API fuzzer for tf.stop_gradient
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.stop_gradient_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.stop_gradient(parameter_0)
