#This is a Python API fuzzer for tf.math.top_k
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.top_k_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		k = k_choices[0]
		sorted_choices = []
		sorted_BOOL = fh.get_bool()
		sorted_choices.append(sorted_BOOL)
		sorted = sorted_choices[0]
		arg_class = tf.math.top_k(parameter_0,k=k,sorted=sorted)
