...
def TestOneInput(data):
	...
	try:
		...
		parameter_1_STR = parameter_1_STR_strlist[fh.get_int(min_int=0, max_int=len(parameter_1_STR_strlist)]
		parameter_1_choices.append(parameter_1_STR)
		parameter_1 = parameter_1_choices[fh.get_int()%1]
		_ = tf.config.set_visible_devices(parameter_0,parameter_1)
