#This is a Python API fuzzer for tf.signal.frame
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.signal.frame_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.signal.frame(parameter_0,parameter_1,parameter_2,pad_end=pad_end)
