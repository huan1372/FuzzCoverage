#This is a Python API fuzzer for tf.keras.layers.SpatialDropout1D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.SpatialDropout1D_exception.txt","a")
	try:
		name_choices = []
		name_STR_strlist = ['spatial_dropout1d'] 
		...
		arg_class = tf.keras.layers.SpatialDropout1D(name=name,trainable=trainable,dtype=dtype,rate=rate,noise_shape=noise_shape,seed=seed,batch_input_shape=batch_input_shape)
