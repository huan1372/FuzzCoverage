...
def TestOneInput(data):
	...
	try:
		name_choices = []
		name_STR_strlist = ['', 'valid', 'sum', 'mean_squared_error', 'mean_squared_logarithmic_error', 'squared_hinge', 'top_k_categorical_accuracy', '1', 'zeros', 'min', 'max', 'mean_absolute_error', 'mean_absolute_percentage_error', 'same', 'my_mean_tensor', 'my_mean', 'poisson'] 
		...
		parameter_0_choices = []
		parameter_0_STR_strlist = ['', 'valid', 'sum', '1', 'zeros', 'same', 'root_mean_squared_error'] 
