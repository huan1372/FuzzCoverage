#This is a Python API fuzzer for tf.optimizers.schedules.ExponentialDecay
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.optimizers.schedules.ExponentialDecay_exception.txt","a")
	try:
		...
		arg_class = tf.optimizers.schedules.ExponentialDecay(initial_learning_rate=initial_learning_rate,decay_steps=decay_steps,decay_rate=decay_rate)
