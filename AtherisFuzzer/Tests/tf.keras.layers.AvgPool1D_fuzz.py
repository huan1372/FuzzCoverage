#This is a Python API fuzzer for tf.keras.layers.AvgPool1D
import atheris
...
def TestOneInput(data):
	...
	try:
		name_choices = []
		name_STR_strlist = ['average_pooling1d', 'average_pooling1d_2', 'average_pooling1d_3', 'average_pooling1d_1', 'average_pooling1d_4'] 
