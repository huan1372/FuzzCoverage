#This is a Python API fuzzer for tf.linalg.triangular_solve
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.linalg.triangular_solve_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.linalg.triangular_solve(parameter_0,parameter_1,lower=lower)
