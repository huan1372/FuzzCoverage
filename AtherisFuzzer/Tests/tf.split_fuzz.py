#This is a Python API fuzzer for tf.split
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.split_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		num_or_size_splits_choices = []
		num_or_size_splits_INT = fh.get_int()
		num_or_size_splits_choices.append(num_or_size_splits_INT)
		num_or_size_splits = num_or_size_splits_choices[0]
		arg_class = tf.split(parameter_0,parameter_1,axis=axis,value=value,num_or_size_splits=num_or_size_splits)
