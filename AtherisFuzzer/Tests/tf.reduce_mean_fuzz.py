#This is a Python API fuzzer for tf.reduce_mean
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.reduce_mean_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.reduce_mean(parameter_0,parameter_1,axis=axis,keepdims=keepdims)
