#This is a Python API fuzzer for tf.losses.Hinge
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.losses.Hinge_exception.txt","a")
	try:
		reduction_choices = []
		...
		arg_class = tf.losses.Hinge(reduction=reduction)
