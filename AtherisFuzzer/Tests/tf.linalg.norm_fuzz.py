#This is a Python API fuzzer for tf.linalg.norm
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.linalg.norm_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		axis = axis_choices[0]
		arg_class = tf.linalg.norm(parameter_0,axis=axis)
