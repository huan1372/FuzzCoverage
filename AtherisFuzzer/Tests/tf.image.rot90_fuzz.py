#This is a Python API fuzzer for tf.image.rot90
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.image.rot90_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		k = k_choices[fh.get_int()%1]
		_ = tf.image.rot90(parameter_0,k=k)
