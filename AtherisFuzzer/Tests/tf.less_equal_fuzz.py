#This is a Python API fuzzer for tf.less_equal
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.less_equal_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.less_equal(parameter_0,parameter_1)
