#This is a Python API fuzzer for tf.nn.dropout
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.nn.dropout_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.nn.dropout(parameter_0,rate=rate)
