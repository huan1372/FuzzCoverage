#This is a Python API fuzzer for tf.math.square
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.square_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.square(parameter_0)
