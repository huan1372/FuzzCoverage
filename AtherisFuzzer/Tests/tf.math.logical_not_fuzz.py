#This is a Python API fuzzer for tf.math.logical_not
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.logical_not_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.logical_not(parameter_0)
