#This is a Python API fuzzer for tf.keras.layers.Convolution1DTranspose
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.Convolution1DTranspose_exception.txt","a")
	try:
		strides_choices = []
