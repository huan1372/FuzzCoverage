...
def TestOneInput(data):
	...
	try:
		...
		name_choices = []
		name_STR_strlist = ['', 'embedding', 'same', 'valid', 'embedding_1', 'sum', 'zeros', '1', 'embedding_3', 'embedding_2'] 
		...
		embeddings_initializer_STR_strlist = ['', 'same', 'valid', 'sum', 'RandomUniform', 'zeros', '1'] 
