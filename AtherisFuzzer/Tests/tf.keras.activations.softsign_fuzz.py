#This is a Python API fuzzer for tf.keras.activations.softsign
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.activations.softsign_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.activations.softsign(parameter_0)
