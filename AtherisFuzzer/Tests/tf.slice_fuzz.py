#This is a Python API fuzzer for tf.slice
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.slice_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.slice(parameter_0,parameter_1,parameter_2)
