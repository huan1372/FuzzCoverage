#This is a Python API fuzzer for tf.keras.layers.SeparableConv2D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.SeparableConv2D_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.layers.SeparableConv2D(parameter_0,parameter_1,padding=padding,use_bias=use_bias,kernel_initializer=kernel_initializer,strides=strides)
