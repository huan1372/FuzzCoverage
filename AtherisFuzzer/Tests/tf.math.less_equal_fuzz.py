#This is a Python API fuzzer for tf.math.less_equal
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.less_equal_exception.txt","a")
	try:
		parameter_0_choices = []
		# Tensor generation for parameter_0
		parameter_0_DTYPES = [tf.float32,tf.int64]
		...
		arg_class = tf.math.less_equal(parameter_0,parameter_1)
