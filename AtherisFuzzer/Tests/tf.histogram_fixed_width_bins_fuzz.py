#This is a Python API fuzzer for tf.histogram_fixed_width_bins
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.histogram_fixed_width_bins_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		nbins = nbins_choices[0]
		arg_class = tf.histogram_fixed_width_bins(parameter_0,parameter_1,nbins=nbins)
