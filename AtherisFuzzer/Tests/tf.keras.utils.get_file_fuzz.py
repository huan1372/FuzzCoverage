...
def TestOneInput(data):
	...
	try:
		fname_choices = []
		fname_STR_strlist = ['jena_climate_2009_2016.csv.zip', 'image2.jpg', 'centernet_hg104_1024x1024_coco17_tpu-32', 'mscoco_label_map.pbtxt', 'image1.jpg'] 
		...
		parameter_0_choices = []
		parameter_0_STR_strlist = ['starry_night.jpg', 'YellowLabradorLooking_new.jpg', 'paris.jpg'] 
