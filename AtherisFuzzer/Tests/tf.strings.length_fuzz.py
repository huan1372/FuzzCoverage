#This is a Python API fuzzer for tf.strings.length
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.strings.length_exception.txt","a")
	try:
		parameter_0_choices = []
		# Tensor generation for parameter_0
		parameter_0_DTYPES = [tf.string]
		...
		unit_choices = []
		unit_STR_strlist = ['UTF8_CHAR'] 
		unit_STR = unit_STR_strlist[fh.get_int(min_int=0, max_int=len(unit_STR_strlist)-1)]
		unit_choices.append(unit_STR)
		unit = unit_choices[0]
		arg_class = tf.strings.length(parameter_0,unit=unit)
