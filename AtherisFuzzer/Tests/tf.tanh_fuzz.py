#This is a Python API fuzzer for tf.tanh
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.tanh_exception.txt","a")
	try:
		parameter_0_choices = []
