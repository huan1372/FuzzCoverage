#This is a Python API fuzzer for tf.size
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.size_exception.txt","a")
	try:
		parameter_0_choices = []
