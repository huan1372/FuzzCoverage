#This is a Python API fuzzer for tf.losses.SparseCategoricalCrossentropy
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.losses.SparseCategoricalCrossentropy_exception.txt","a")
	try:
		reduction_choices = []
		...
		arg_class = tf.losses.SparseCategoricalCrossentropy(reduction=reduction,from_logits=from_logits)
