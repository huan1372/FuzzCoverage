#This is a Python API fuzzer for tf.initializers.variance_scaling
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.initializers.variance_scaling_exception.txt","a")
	try:
		scale_choices = []
		...
		arg_class = tf.initializers.variance_scaling(scale=scale,mode=mode,distribution=distribution)
