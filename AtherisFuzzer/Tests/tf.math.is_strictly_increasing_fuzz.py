#This is a Python API fuzzer for tf.math.is_strictly_increasing
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.is_strictly_increasing_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.is_strictly_increasing(parameter_0)
