#This is a Python API fuzzer for tf.square
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.square_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.square(parameter_0)
