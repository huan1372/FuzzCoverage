#This is a Python API fuzzer for tf.add
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.add_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.add(parameter_0,parameter_1)
