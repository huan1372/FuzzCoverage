#This is a Python API fuzzer for tf.math.logical_and
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.logical_and_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.logical_and(parameter_0,parameter_1)
