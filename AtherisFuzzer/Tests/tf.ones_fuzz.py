#This is a Python API fuzzer for tf.ones
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.ones_exception.txt","a")
	try:
		parameter_0_choices = []
		parameter_0_LIST = fh.get_int_list(min_length=2, max_length=6)
		...
		shape_choices = []
		shape_LIST = fh.get_int_list(min_length=2, max_length=2)
		...
		arg_class = tf.ones(parameter_0,parameter_1,shape=shape,dtype=dtype)
