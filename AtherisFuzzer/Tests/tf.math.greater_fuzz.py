#This is a Python API fuzzer for tf.math.greater
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.greater_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.greater(parameter_0,parameter_1)
