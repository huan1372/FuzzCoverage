#This is a Python API fuzzer for tf.ones_like
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.ones_like_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.ones_like(parameter_0,dtype=dtype)
