#This is a Python API fuzzer for tf.random.uniform
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.random.uniform_exception.txt","a")
	try:
		shape_choices = []
		shape_LIST = fh.get_int_list(min_length=0, max_length=3)
		...
		dtype_choices = []
		dtype_DTYPE_dtypelist = ['tf.int32', 'tf.int64'] 
		...
		arg_class = tf.random.uniform(shape=shape,maxval=maxval,dtype=dtype,seed=seed,minval=minval,parameter_0,parameter_1,parameter_2)
