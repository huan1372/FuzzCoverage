#This is a Python API fuzzer for tf.keras.layers.Convolution3D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.Convolution3D_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.layers.Convolution3D(parameter_0,parameter_1,activation=activation,input_shape=input_shape)
