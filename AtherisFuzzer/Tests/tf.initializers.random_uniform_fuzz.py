#This is a Python API fuzzer for tf.initializers.random_uniform
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.initializers.random_uniform_exception.txt","a")
	try:
		minval_choices = []
		...
		arg_class = tf.initializers.random_uniform(minval=minval,maxval=maxval,seed=seed)
