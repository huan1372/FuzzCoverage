#This is a Python API fuzzer for tf.math.cumsum
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.cumsum_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		axis = axis_choices[0]
		arg_class = tf.math.cumsum(parameter_0,axis=axis)
