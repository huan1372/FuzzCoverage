#This is a Python API fuzzer for tf.keras.layers.Convolution1D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.Convolution1D_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		name_choices = []
		name_STR_strlist = ['conv1d', 'conv1d_1'] 
