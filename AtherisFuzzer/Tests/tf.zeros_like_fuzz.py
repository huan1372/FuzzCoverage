#This is a Python API fuzzer for tf.zeros_like
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.zeros_like_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.zeros_like(parameter_0,dtype=dtype)
