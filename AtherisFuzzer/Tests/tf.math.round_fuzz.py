#This is a Python API fuzzer for tf.math.round
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.round_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.round(parameter_0)
