#This is a Python API fuzzer for tf.nn.leaky_relu
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.nn.leaky_relu_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.nn.leaky_relu(parameter_0)
