#This is a Python API fuzzer for tf.keras.activations.swish
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.activations.swish_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.keras.activations.swish(parameter_0)
