#This is a Python API fuzzer for tf.math.conj
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.conj_exception.txt","a")
	try:
		parameter_0_choices = []
		# Tensor generation for parameter_0
		parameter_0_DTYPES = [tf.complex128,tf.float32]
		...
		arg_class = tf.math.conj(parameter_0)
