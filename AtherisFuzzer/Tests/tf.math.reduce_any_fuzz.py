#This is a Python API fuzzer for tf.math.reduce_any
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.reduce_any_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.reduce_any(parameter_0)
