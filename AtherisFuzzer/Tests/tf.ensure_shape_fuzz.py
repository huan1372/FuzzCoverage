#This is a Python API fuzzer for tf.ensure_shape
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.ensure_shape_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.ensure_shape(parameter_0,parameter_1)
