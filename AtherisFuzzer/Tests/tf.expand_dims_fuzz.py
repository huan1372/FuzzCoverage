#This is a Python API fuzzer for tf.expand_dims
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.expand_dims_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.expand_dims(parameter_0,axis=axis,parameter_1)
