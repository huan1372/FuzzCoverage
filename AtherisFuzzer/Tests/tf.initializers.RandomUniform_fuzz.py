#This is a Python API fuzzer for tf.initializers.RandomUniform
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.initializers.RandomUniform_exception.txt","a")
	try:
		minval_choices = []
		...
		arg_class = tf.initializers.RandomUniform(minval=minval,maxval=maxval,seed=seed)
