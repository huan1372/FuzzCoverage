#This is a Python API fuzzer for tf.ragged.range
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.ragged.range_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.ragged.range(parameter_0,parameter_1,parameter_2)
