#This is a Python API fuzzer for tf.broadcast_to
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.broadcast_to_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		parameter_1_choices = []
		parameter_1_LIST = fh.get_int_list(min_length=2, max_length=3)
		parameter_1_choices.append(parameter_1_LIST)
		parameter_1 = parameter_1_choices[0]
		arg_class = tf.broadcast_to(parameter_0,parameter_1)
