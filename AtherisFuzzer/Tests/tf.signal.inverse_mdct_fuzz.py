#This is a Python API fuzzer for tf.signal.inverse_mdct
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.signal.inverse_mdct_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.signal.inverse_mdct(parameter_0,window_fn=window_fn)
