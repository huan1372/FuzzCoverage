...
def TestOneInput(data):
	...
	try:
		...
		parameter_0_LIST = fh.get_int_list(min_length=2, max_length=5)
		parameter_0_choices.append(parameter_0_LIST)
		parameter_0_STR_strlist = ['', 'palmer 30', 'zeros', 'same', '1', 'valid', 'sum'] 
		...
		dtype_choices = []
		dtype_DTYPE_dtypelist = ['', 'zeros', 'same', '1', 'valid', 'sum', 'tf.float32'] 
