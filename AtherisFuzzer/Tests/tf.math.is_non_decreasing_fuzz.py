#This is a Python API fuzzer for tf.math.is_non_decreasing
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.is_non_decreasing_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.is_non_decreasing(parameter_0)
