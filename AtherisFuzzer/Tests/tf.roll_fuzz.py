#This is a Python API fuzzer for tf.roll
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.roll_exception.txt","a")
	try:
		parameter_0_choices = []
		# Tensor generation for parameter_0
		parameter_0_DTYPES = [tf.bool,tf.float32]
		...
		arg_class = tf.roll(parameter_0,parameter_1,axis=axis,shift=shift)
