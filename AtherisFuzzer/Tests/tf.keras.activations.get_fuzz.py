#This is a Python API fuzzer for tf.keras.activations.get
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.activations.get_exception.txt","a")
	try:
		parameter_0_choices = []
		parameter_0_STR_strlist = ['softmax'] 
		...
		arg_class = tf.keras.activations.get(parameter_0)
