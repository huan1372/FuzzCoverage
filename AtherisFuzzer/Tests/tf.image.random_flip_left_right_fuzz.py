#This is a Python API fuzzer for tf.image.random_flip_left_right
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.image.random_flip_left_right_exception.txt","a")
	try:
		parameter_0_choices = []
