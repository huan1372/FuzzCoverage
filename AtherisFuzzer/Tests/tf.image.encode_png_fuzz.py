#This is a Python API fuzzer for tf.image.encode_png
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.image.encode_png_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.image.encode_png(parameter_0)
