#This is a Python API fuzzer for tf.losses.binary_crossentropy
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.losses.binary_crossentropy_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.losses.binary_crossentropy(parameter_0,parameter_1)
