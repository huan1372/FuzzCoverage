#This is a Python API fuzzer for tf.keras.layers.Convolution3DTranspose
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.Convolution3DTranspose_exception.txt","a")
	try:
		name_choices = []
