#This is a Python API fuzzer for tf.keras.layers.Softmax
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.Softmax_exception.txt","a")
	try:
		name_choices = []
		name_STR_strlist = ['softmax'] 
		...
		axis_LIST = fh.get_int_list(min_length=1, max_length=2)
		...
		arg_class = tf.keras.layers.Softmax(name=name,trainable=trainable,dtype=dtype,axis=axis,batch_input_shape=batch_input_shape)
