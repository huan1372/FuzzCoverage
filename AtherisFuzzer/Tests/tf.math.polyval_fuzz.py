#This is a Python API fuzzer for tf.math.polyval
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.math.polyval_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.math.polyval(parameter_0,parameter_1)
