#This is a Python API fuzzer for tf.keras.layers.MaxPooling3D
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.layers.MaxPooling3D_exception.txt","a")
	try:
		strides_choices = []
		...
		arg_class = tf.keras.layers.MaxPooling3D(strides=strides,padding=padding,data_format=data_format,pool_size=pool_size,name=name,trainable=trainable,batch_input_shape=batch_input_shape,dtype=dtype)
