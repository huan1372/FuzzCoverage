#This is a Python API fuzzer for tf.keras.activations.gelu
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.keras.activations.gelu_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		approximate_choices = []
		approximate_BOOL = fh.get_bool()
		approximate_choices.append(approximate_BOOL)
		approximate = approximate_choices[0]
		arg_class = tf.keras.activations.gelu(parameter_0,approximate=approximate)
