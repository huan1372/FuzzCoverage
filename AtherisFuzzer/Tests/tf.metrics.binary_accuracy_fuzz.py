#This is a Python API fuzzer for tf.metrics.binary_accuracy
import atheris
...
def TestOneInput(data):
	...
	f = open("/home/usr/FreeFuzz/FuzzCoverage/AtherisFuzzer/Exceptions/tf.metrics.binary_accuracy_exception.txt","a")
	try:
		parameter_0_choices = []
		...
		arg_class = tf.metrics.binary_accuracy(parameter_0,parameter_1)
